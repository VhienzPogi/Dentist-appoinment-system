...
<head>
  ...
  <title>Schedule | Dental Legends</title>
...
<body>
  ...
  <header class="header">
    <div class="logo">
      <img src="Logo.jpg" alt="Dental Legends Logo" />
    </div>
    <nav class="nav">
  ...
  <div class="schedule-container schedule-fade">
    ...
    <p><strong>Prepared By:</strong> <span>Dental Legends Admin</span></p>
  ...
  <script>
    ...
    document.querySelectorAll(".schedule-table tbody tr").forEach(row => {
      row.addEventListener("mouseenter", () => row.style.backgroundColor = "#fff3e6");
      row.addEventListener("mouseleave", () => row.style.backgroundColor = "");
    });

    // LIVE SEARCH
    document.getElementById("searchAppointments").addEventListener("keyup", () => {
      const filter = searchAppointments.value.toLowerCase();
      document.querySelectorAll(".schedule-table tbody tr").forEach(row => {
    ...
    document.getElementById("appointmentCount").textContent =
      document.querySelectorAll(".schedule-table tbody tr").length;
